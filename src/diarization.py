...
class Diarizer:
    ...
    def diarize(
        ...
        min_speakers : int, optional
            Minimum expected number of speakers.  Helps pyannote avoid
            merging distinct speakers into one cluster.
        ...
        logger.info(
            "Running diarization on %s (min_speakers=%s, max_speakers=%s) …",
        ...
        diarization = self._pipeline(audio_path, **diarize_kwargs)
